...
export default function SearchBar({ onSearchChange, placeholder = "Search meeting requests..." }) {
  ...
  return (
    <div className="flex-1 max-w-md mx-4 relative">
      {/* Search Icon */}
      <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none" data-testid="search-icon">
      ...
      <input
        ...
        className="w-full pl-10 pr-10 py-2 border-2 border-white bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all shadow-sm"
